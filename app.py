...
def datetime_filter(t):
	deltatime=int(time.time()-t)
	if deltatime<60:
		return u'1 minute ago'
	if deltatime<3600:
		return u'%s minutes ago' % (deltatime//60)
	if deltatime<(3600*24):
		return u'%s hours ago' % (deltatime//3600)
	if deltatime<(3600*24*24):
		return u'%s days ago' % (deltatime//3600*24)
